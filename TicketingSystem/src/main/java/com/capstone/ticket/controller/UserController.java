...
//	}
	...
	public ModelAndView signUpUser(@RequestParam("name") String name,@RequestParam("password") String password, @RequestParam("address") String address,@RequestParam("contact") String contact) {
	...
	public ModelAndView updateUser(@PathVariable String name,@RequestParam("name") String newname,@RequestParam("password") String password, @RequestParam("address") String address,@RequestParam("contact") String contact) {
